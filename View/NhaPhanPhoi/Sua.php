<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">Sửa nhà phân phối</h3>
	</div>
			...
			else
			{
				...
				<form class="form-horizontal" role="form" id="frmTacGia">
					<div class="form-group">
						<label class="control-label col-sm-2">Mã nhà phân phối: </label>
						<div class="col-sm-10">
							<p class="form-control-static">$matg</p>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2" for="tentg">Tên nhà phân phối: </label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<div class="col-sm-10 col-sm-offset-2">
							<button type="submit" class="btn btn-primary">Sửa nhà phân phối</button>
						</div>
					</div>
				</form>
EOD;
...
<script>
	$(document).ready(function(){
		$('#frmTacGia').validate({
			messages: {
				tentg: {
					required: "Bạn chưa nhập tên nhà phân phối"
				}
			}
		})
	});
