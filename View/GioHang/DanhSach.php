		...
		<div class="panel-body">
			<?php
				if(count($result) == 0 || !isset($_SESSION['GioHang'])):
					$thongbao = <<< EOD
					<h5>Bạn không có xe nào trong giỏ</h5>
					<div>
						<a href="index.php">Nhấp vào đây để xem các xe khác</a>
					</div>
EOD;
					echo $thongbao;
				else:
			...
			<table class="table table-hover table-bordered">
				<thead>
					<tr>
						<th>STT</th><th>Thông tin xe</th><th>Số lượng</th><th class="text-right">Xoá xe</th><th class="text-right">Tổng giá bán</th>
					</tr>
				</thead>
				<tbody>
					<?php
