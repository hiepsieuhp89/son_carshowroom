...
?>
	<form class="form-horizontal" role="form" id="frmSuaHoaDon">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<?php
				if ($result_hd['TRANGTHAI'] == 0)
					$trangthai = 'Chưa giao';
				if ($result_hd['TRANGTHAI'] == 1) {
					$trangthai = 'Đang giao';
				}
				if ($result_hd['TRANGTHAI'] == 2) {
					$trangthai = 'Đã giao';
				}
				if ($result_hd['TRANGTHAI'] == 3) {
					$trangthai = 'Đã hủy';
				}
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<p class="form-control-static">{$trangthai}</p>
								</div>
							</div>
							<div class="form-group">
...
EOD;
				...
				<select name="trangthai" class="form-control input-inline" style="width: 200px">
					<option value="0" <?php if ($result_hd['TRANGTHAI'] == 0) echo "selected" ?>>Chưa giao</option>
					<option value="1" <?php if ($result_hd['TRANGTHAI'] == 1) echo "selected" ?>>Đang giao</option>
					<option value="2" <?php if ($result_hd['TRANGTHAI'] == 2) echo "selected" ?>>Đã giao</option>
					<option value="3" <?php if ($result_hd['TRANGTHAI'] == 3) echo "selected" ?>>Hủy</option>
				</select>
			</div>
			<div class="panel-footer">
