	...
	<div class="panel-body">
		...
		<div class="table-responsive">
			<table class="table table-hover table-bordered">
				<thead>
					<tr>
						<th>STT</th><th>Ngày</th><th>Số lượng xe đã bán</th><th class="text-right">Tổng doanh thu</th>
					</tr>
				</thead>
				<tbody>
					<?php
			...
			<script>
				$().ready(function(e){
					$('#xuatpdf').click(function(e){
						...
						table.unshift([{text: "STT", bold: true}, {text: "Ngày", bold: true}, {text: "Số lượng xe đã bán", bold: true}, {text: "Tổng doanh thu", bold: true, alignment: 'right'}]);
