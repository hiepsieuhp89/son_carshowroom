 ...
 <div class="fixed-action-btn horizontal">
    ...
    <ul>
      @if (Route::current()->getName()=='homepage')
            ...
            <li><a href="{{ route('book.index') }}" class="btn-floating green tooltipped" data-position="top" data-tooltip="Quản lý Xe"><i class="material-icons">library_books</i></li>
      ...
      @if (Route::current()->getName()=='viewBook' )
            <li><a href="{{ route('book.edit',$book->bookId) }}" class="btn-floating blue tooltipped" data-position="top" data-tooltip="Sửa xe: {{$book->book_name}} "><i class="material-icons">library_books</i></a></li>
            <li><a href="{{ route('author.edit',$book->authorId) }}" class="btn-floating yellow tooltipped" data-position="top" data-tooltip="Sửa nhà phân phối: {{$book->author_name}}"><i class="material-icons">person_pin</i></a></li>
      ...
      @if (in_array(Route::current()->getName(),array('viewHotBookWeek','viewHotBookMonth','viewBookNewPublish')) )
            <li><a href="{{ route('book.index') }}" class="btn-floating blue tooltipped" data-position="top" data-tooltip="Quản lý xe"><i class="material-icons">library_books</i></a></li>
      @endif
      @if (Route::current()->getName()=='viewAuthor' && isset($authorInfo->id) )
            <li><a href="{{ route('author.edit',$authorInfo->id) }}" class="btn-floating blue tooltipped" data-position="top" data-tooltip='Sửa nhà phân phối: {{$authorInfo->author_name}} ' ><i class="material-icons">perm_identity</i></a></li>
      @endif
