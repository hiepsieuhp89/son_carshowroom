...
<head>
    ...
    <title>@yield('title') - Tiki.vn - Website showroom xe hơi hàng đầu VN</title>
                        ...
                        <div class="row">
                            ...
                            <form class="col l5" action="{{ route('search') }}" method="GET" style="" id='form-submit'>
                                ...
                                <div class="search-wrapper card">
                                    <input id="search" name="txtSearch" placeholder="Nhập tên xe, nhà phân phối, cty phát hành" value="{{(isset($txtSearch))?$txtSearch:''}}">
