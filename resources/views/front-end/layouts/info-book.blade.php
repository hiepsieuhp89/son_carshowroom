<div class="col-xs-12">
    <div class="product-content-box">
        <h3 class="product-table-title">Giới Thiệu Xe</h3>
        <div class="row">
            <div class="col-xs-8">
        ...
        <div class="product-table-box row">
          @php
            $arrayName = array(
              ...
              'Nhà phân phối' => $book->author_name ,
              'Dịch giả' => $book->translator ,
              'Dung tích xi lanh' => $book->number_of_pages ,
              'Nhà phân phối' => $book->publishing_house ,
        ...
        <h3 class="product-table-title">Giới Thiệu Nhà phân phối</h3>
        <div class="row">
            <div class="col-xs-8">
                <div class="product-content-detail">
