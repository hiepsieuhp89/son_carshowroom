    ...
    <div class="row">
      ...
      <div class="col l4 offset-l2 s12">
        ...
        <ul>
          ...
          <li><a class="grey-text text-lighten-3" href="{{ route('viewHotBookWeek') }}">Xe bán chạy trong tuần</a></li>
          <li><a class="grey-text text-lighten-3" href="{{ route('viewHotBookMonth') }}">Xe bán chạy trong tháng</a></li>
          <li><a class="grey-text text-lighten-3" href="{{ route('viewBookNewPublish') }}">Xe mới</a></li>
