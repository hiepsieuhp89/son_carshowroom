<ul>
    <li><a href="{{ route('viewHotBookWeek') }}">Xe bán chạy trong tuần</a></li>
    <li><a href="{{ route('viewHotBookMonth') }}">Xe bán chạy trong tháng</a></li>
    <li><a href="{{ route('viewBookNewPublish') }}">Xe mới xuất bản</a></li>
        ...
        <li>
            ...
            <div class="nav-sub">
                <ul>
                    ...
                    <li>
                        <div class="nav-sub-list-box">
                            <a href="{{ route('viewAuthor',0) }}"><h2>Nhà phân phối</h2></a>
                            ...
                            <a href="{{ route('viewAuthor',0) }}" class="all">
                                Xem tất cả nhà phân phối ...<i class="fa fa-caret-right"></i> 
                            </a>
                        </div>
                    </li>
                </ul>
