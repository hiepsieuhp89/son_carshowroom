	...
	<form class="col s12" method="POST" action="{{ route('author.store') }}">
      ...
      <div class="row">
        ...
        <i class="material-icons prefix">account_circle</i>
          <input placeholder="Nhập tên nhà phân phối" id="icon_prefix" name="txtNameAuthor" type="text" class="validate" value="">
      ...
      <div class="row">
        <div class="input-field col s3">
           <button class="btn waves-effect waves-light" type="submit"  value="edit" name="btn_edit">Thêm nhà phân phối
