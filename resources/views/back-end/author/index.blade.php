              ...
              <table>
		        <thead>
		          <tr>
		              ...
		              <th data-field="name">Tên nhà phân phối</th>
		              <th data-field="image">Giới thiệu</th>
		              <th data-field="image">Ảnh</th>
		              <th data-field="total">Tổng số xe</th>
		        ...
		        <tbody>
		          <tr dir-paginate="author in authors | filter:q | itemsPerPage: pageSize" current-page="currentPage">
		            ...
		            <td>
                  <img ng-if="author.author_image" width="70"  class="responsive-img" ng-src="http://localhost/TienThinhAutomatic{{author.author_image}}">
                </td>
		            <td>{{author.total}}</td>
