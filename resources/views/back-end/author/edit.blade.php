...
<div class="row"> 
	<form class="col s12 m6" method="POST" action="{{ route('author.update',$author->id) }}">
      ...
      <div class="row">
        ...
        <i class="material-icons prefix">account_circle</i>
          <input placeholder="Nhập tên nhà phân phối" id="icon_prefix" name="txtNameAuthor" type="text" class="validate" required autofocus value="{{$author->author_name}}">
          <label for="icon_prefix">Tên nhà phân phối</label>
        ...
        <div class="input-field col s12">
	          ...
	          <label for="icon_prefix2">Thông tin nhà phân phối</label>
     ...
     <div class="row">
        <div class="input-field col s12">
          ...
          <label for="disabled">Tổng số xe</label>
        </div>
      </div>
      <div class="row">
  ...
  <div class="col s12 m6">
    @if (count($books)>0)
      <h4 class="red-text">Nhà phân phối có {{count($books)}} đầu xe</h4>
      <ul>
...
<form class="col s12 fmtDelete" method="POST" action="{{ route('author.destroy',$author->id) }}">
  ...
  <div class="row">
    <div class="input-field col s3">
       <button class="btn waves-effect waves-light red" data-target="modalConfirmDelete" type="submit"  value="delete" name="btn_delete">Xóa Nhà phân phối
          <i class="material-icons right">send</i>
        </button>
    </div>
  </div>
  ...
  <div id="modalConfirmDelete" class="modal sm-modal">
    <div class="modal-content">
      ...
      <p>Nhà phân phối và các xe có liên quan sẽ bị xóa</p>
    </div>
