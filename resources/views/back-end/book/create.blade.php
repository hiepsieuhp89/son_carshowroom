  ...
  <form class="col s12 l8" method="POST"  enctype="multipart/form-data" action="{{ route('book.store') }}">
    ...
    <div class="row"> 
        <div class="input-field col s12">
          ...
          <label for="book_name">Tên xe</label>
        </div>
    </div>
    <div class="row"> 
        <div class="input-field col s12">
          ...
          <label for="author">Nhà phân phối</label>
        </div>
    </div>
    <div class="row"> 
        <div class="input-field col s12">
    ...
    <div class="row"> 
        <div class="input-field col s6">
          ...
          <label for="publish_house">Nhà phân phối</label>
        </div>
        <div class="input-field col s6">
    ...
    <div class="row"> 
        <div class="input-field col s6">
          ...
          <label for="page">Dung tích xi lanh</label>
        </div>
        <div class="input-field col s6">
    ...
    <div class="row">
      <div class="input-field col s3">
         <button class="btn waves-effect waves-light" type="submit"  value="edit" name="btn_edit">Thêm xe
            <i class="material-icons right">send</i>
          </button>
      </div>
    </div>
