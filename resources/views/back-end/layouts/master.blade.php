...
<head>
    ...
    <title>@yield('title') - Website showroom xe hơi</title>
...
<body >
          ...
          <ul id="nav-mobile" class="right hide-on-med-and-down">
               @if (Auth::guest())
                ...
                <ul id="dropdown1" class="dropdown-content">
                    <li><a href="{{ route('save.index') }}">Xe mua sau</a></li>
    ...
    <div class="row">
        <div class="owl-carousel owl-carousel-menu " style="border-bottom: 1px solid #e0e0e0">
            ...
            <div class="item">
                <a href="{{ route('book.index') }}"><i class="material-icons">library_books</i><span>Xe</span></a>
            </div>
            <div class="item">
            ...
            <div class="item">
                <a href="{{ route('author.index') }}"> <i class="material-icons">perm_contact_calendar</i><span>Nhà phân phối</span></a>
            </div>
            <div class="item">
