...
<head>
	<meta charset="UTF-8">
	<title>Trang quản lý showroom xe hơi</title>
		...
		<div class="col-md-3">
			<div class="sidebar" data-spy="affix">
				<ul class="nav nav-pills nav-stacked" >
					...
					<li <?php if((isset($_REQUEST['c']) && $_REQUEST['c'] == 'DanhMuc') || !isset($_REQUEST['c'])) echo "class='select'"; ?> ><a href='admin.php?c=DanhMuc&act=QuanLy'><span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span> Quản lý danh mục xe</a></li>
					<li <?php if(isset($_REQUEST['c']) && $_REQUEST['c'] == 'LoaiXe') echo "class='select'"; ?> ><a href='admin.php?c=LoaiXe&act=QuanLy'><span class="glyphicon glyphicon-tags" aria-hidden="true"></span> Quản lý loại xe</a></li>
					<li <?php if(isset($_REQUEST['c']) && $_REQUEST['c'] == 'Xe') echo "class='select'"; ?> ><a href='admin.php?c=Xe&act=QuanLy'><span class="glyphicon glyphicon-book" aria-hidden="true"></span> Quản lý xe</a></li>
					<li <?php if(isset($_REQUEST['c']) && $_REQUEST['c'] == 'NhaPhanPhoi') echo "class='select'"; ?> ><a href='admin.php?c=NhaPhanPhoi&act=QuanLy'><span class="glyphicon glyphicon-list" aria-hidden="true"></span> Quản lý nhà phân phối</a></li>
					<li <?php if(isset($_REQUEST['c']) && $_REQUEST['c'] == 'Kho') echo "class='select'"; ?> ><a href='admin.php?c=Kho&act=QuanLy'><span class="glyphicon glyphicon-inbox" aria-hidden="true"></span> Quản lý kho</a></li>
					...
					<!-- <li <?php if(isset($_REQUEST['c']) && $_REQUEST['c'] == 'BinhLuan') echo "class='select'"; ?> ><a href='admin.php?c=BinhLuan&act=QuanLy'><span class="glyphicon glyphicon-list" aria-hidden="true"></span> Quản lý bình luận</a></li> -->
					<li class="nav-divider"></li>
				</ul>
